...
// ── Defined OUTSIDE RegisterPage so it is never recreated on re-render ───────
function Field({ name, label, type = 'text', placeholder, value, onChange, error, focused, onFocus, onBlur }) {
  return (
    <div>
